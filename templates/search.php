    ...
    <div class="container">
        ...
        <?php if ($pagesCount > 1) { ?>
            <ul class="pagination-list">
                ...
                <?php } ?>
                <li class="pagination-item pagination-item-next"><a href="search.php?search=<?= htmlspecialchars($_GET['search']) ;?>&page=<?= $currentPage === strval($pagesCount) ? $currentPage : $currentPage + 1 ;?>">Вперед</a></li>
            </ul>
        <?php } ?>
    </div>
</main>
